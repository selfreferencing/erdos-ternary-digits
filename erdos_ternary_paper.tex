...
\date{January 2025 \\ \small Version 5 (2025-01-25 18:00 UTC)}
...
\]
This sum represents a measure-theoretic accounting: viewing residue classes as cylinder sets in $\mathbb{Z}_3$, the rejection sets have total measure 1. However, this density statement alone does not rule out a measure-zero exceptional set; the 3-adic induction in Theorem~\ref{thm:unique} provides the deterministic argument that $j = 3$ is the unique survivor.
\end{proof}
