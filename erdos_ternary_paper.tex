...
\date{January 2025 \\ \small Version 6 (2025-01-25 18:30 UTC)}
...
For the small cases: $j = 1$ has digits $[2, 2]$ (LSB first), rejection at position 1. $j = 2$ has digits $[2, 1, 0, 1]$, rejection at position 3. $j = 3$ has digits $[2, 0, 2, 1, 1]$, no rejection---the sequence avoids all rejection conditions, and trailing zeros are always safe since $s_0 \xrightarrow{0} s_0$ and $s_1 \xrightarrow{0} s_0$.
\end{proof}
